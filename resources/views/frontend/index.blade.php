    ...
    <div class="container">
      <div class="row"> 
        ...
        <div class="col-xs-12 col-sm-12 col-md-3 sidebar"> 
          ...
          @include('frontend.product.common_top_navigation')
          <!-- /.side-menu --> 
          <!-- ================================== TOP NAVIGATION : END ================================== --> 
          
          <!-- ============================================== HOT DEALS ============================================== -->
           @include('frontend.product.common_hot_deals')
          <!-- ============================================== HOT DEALS: END ============================================== --> 
          
          <!-- ============================================== SPECIAL OFFER ============================================== -->
          
          <div class="sidebar-widget outer-bottom-small wow fadeInUp">
            <h3 class="section-title">{{session()->get('language')=='bangla'? 'বিশেষ অফার': 'Special Offer' }}</h3>
              ...
              <div class="owl-carousel sidebar-carousel special-offer custom-carousel owl-theme outer-top-xs">
                ...
                <div class="item">
                  <div class="products special-product">
                    ...
                    @empty
                    <h5 class="test text-danger">No Product Found</h5>
          ...
          <div class="sidebar-widget outer-bottom-small wow fadeInUp">
            <h3 class="section-title">{{session()->get('language')=='bangla'? 'বিশেষ ডিল ': 'Special Deals' }}</h3>
            <div class="sidebar-widget-body outer-top-xs">
              <div class="owl-carousel sidebar-carousel special-offer custom-carousel owl-theme outer-top-xs">
                <div class="item">
                  <div class="products special-product">
                    ...
                    <div class="product">
                      <div class="product-micro">
                        <div class="row product-micro-row">
                          ...
                          <div class="col col-xs-7">
                            <div class="product-info">
                              <h3 class="name"><a href="#">{{ session()->get('language')=='bangla'? $product->product_name_ban:$product->product_name_en }}</a></h3>
                              <div class="rating rateit-small"></div>
                              <div class="product-price"> <span class="price">{{ $product->selling_price }} </span> </div>
                              <!-- /.product-price --> 
              ...
              <div class="item" style="background-image: url({{asset ($slider->slider_img) }});">
                <div class="container-fluid">
                  <div class="caption bg-color vertical-center text-left">
                    ...
                    <div class="big-text fadeInDown-2"> {{ $slider->title }} </div>
          ...
          <div id="product-tabs-slider" class="scroll-tabs outer-top-vs wow fadeInUp">
            <div class="more-info-tab clearfix ">
              ...
              <ul class="nav nav-tabs nav-tab-line pull-right" id="new-products-1">
                ...
                <li><a data-transition-type="backSlide" href="#category{{ $category->id }}" data-toggle="tab">{{ session()->get('language')=='bangla' ? $category->category_name_ban:$category->category_name_en}}</a></li>
             ...
             @foreach ($categories as $category)
              ...
              <div class="tab-pane" id="category{{ $category->id }}">
                <div class="product-slider">
                  ...
                  @php
                    $productwithcategory=App\Models\Product::where('category_id',$category->id)->
                    OrderBy('product_name_en','ASC')->get();
                  @endphp
                  ...
                  <div class="product">
                    ...
                    <div class="cart clearfix animate-effect">
                      <div class="action">
                        <ul class="list-unstyled">
                          <li class="add-cart-button btn-group">
                            <button  class="btn btn-primary icon" id="{{ $product->id }}" onclick="ProductView(this.id)" type="button" title="Add Cart" data-toggle="modal" 
