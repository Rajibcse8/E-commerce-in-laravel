        ...
        <div class="header-top-inner">
          ...
          <div class="cnt-block">
            <ul class="list-unstyled list-inline">
              ...
              <li class="dropdown dropdown-small"> <a href="#" class="dropdown-toggle" data-hover="dropdown" data-toggle="dropdown"><span class="value">Select Language </span><b class="caret"></b></a>
                <ul class="dropdown-menu">
